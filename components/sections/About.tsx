...
export default function About() {
  ...
  const highlights = [
    {
      icon: Shield,
      title: language === "es" ? "Seguridad & Lógica" : "Security & Logic",
      text: language === "es" ? "Cifrado extremo y patrones seguros de alta disponibilidad." : "Extreme encryption and secure high-availability patterns."
    },
    {
      icon: Zap,
      title: language === "es" ? "IA & Performance" : "AI & Performance",
      text: language === "es" ? "Agentes autónomos, MCP y optimización de baja latencia." : "Autonomous agents, MCP, and low-latency optimization."
    }
  ];

  return (
    <section id="about" className="py-20 md:py-32 relative overflow-hidden bg-background px-4 md:px-0">
